...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        // NICHT SICHER BEI GPS UND FOTO TYPE, SELBIGES GILT FÜR KATEGORIE ICON
        db.execSQL("CREATE TABLE "+TABLE_NAME_MAIN+" (ID INTEGER PRIMARY KEY AUTOINCREMENT, BETRAG FLOAT, TITEL TEXT, KATEGORIE TEXT, DATUM DATE, GPS TEXT, FOTO TEXT)");
